...
// ============================================================
const DISORDERS = [
  {id:'cyberchondria',name:'Cyberchondria',icon:'🔍',color:'#3d6fff',bg:'rgba(61,111,255,0.1)',scale:'CSS-15',scaleRef:'Norr et al., 2015 · Cyberchondria Severity Scale',items:15,maxScore:75,
    questions:[
      {t:"I search online for health information about symptoms I am experiencing."},
      {t:"I find it difficult to stop searching online for health information once I start."},
      {t:"I feel more anxious about my health after searching online for medical information."},
      {t:"I search online for health information repeatedly throughout the day."},
      {t:"I search for health information online even when I don't have any symptoms."},
      {t:"Online health searches cause me significant distress."},
      {t:"I seek reassurance from others after finding health information online."},
      {t:"I find that online health searches confirm my worst fears about my health."},
      {t:"I avoid certain websites after finding disturbing health information online."},
      {t:"I feel compelled to look up more health information even when I know it will make me anxious."},
      {t:"Online health searching interferes with my daily activities."},
      {t:"I have difficulty controlling how much time I spend searching for health information online."},
      {t:"I feel worse about my health after conducting online health searches."},
      {t:"My online health searches lead me to believe I have serious illnesses."},
      {t:"I spend hours searching online for information about symptoms or diseases."}
    ],
    options:["Never","Rarely","Sometimes","Often","Very Often"],optionValues:[1,2,3,4,5],
    levels:[
      {min:15,max:30,label:'Minimal',color:'#2ecc71',bg:'rgba(46,204,113,0.1)',desc:'Your health searching behavior is within normal limits.'},
  ...
  {id:'socialmedia',name:'Social Media Addiction',icon:'📱',color:'#7c5cbf',bg:'rgba(124,92,191,0.1)',scale:'BSMAS',scaleRef:'Andreassen et al., 2016 · Bergen Social Media Addiction Scale',items:6,maxScore:30,
    questions:[
    ...
    options:["Very Rarely","Rarely","Sometimes","Often","Very Often"],optionValues:[1,2,3,4,5],
    levels:[
  ...
  {id:'shortform',name:'Short-Form Video Addiction',icon:'🎬',color:'#ff4757',bg:'rgba(255,71,87,0.1)',scale:'SVAS-6',scaleRef:'Zhang et al., 2022 · Short-Form Video Addiction Scale',items:6,maxScore:30,
    questions:[
    ...
    options:["Strongly Disagree","Disagree","Neutral","Agree","Strongly Agree"],optionValues:[1,2,3,4,5],
    levels:[
  ...
  {id:'gaming',name:'Gaming Disorder',icon:'🎮',color:'#2ecc71',bg:'rgba(46,204,113,0.1)',scale:'IGDS9-SF',scaleRef:'Pontes & Griffiths, 2015 · Internet Gaming Disorder Scale · WHO ICD-11 aligned',items:9,maxScore:45,
    questions:[
  ...
  {id:'ai',name:'AI Dependency',icon:'🤖',color:'#00c9a7',bg:'rgba(0,201,167,0.1)',scale:'PCGUS',scaleRef:'Problematic ChatGPT Use Scale, 2025 · ⚠️ Turkish sample only — interpret with caution',items:9,maxScore:45,
    questions:[
  ...
  {id:'workaddiction',name:'Digital Work Addiction',icon:'💼',color:'#ff6b35',bg:'rgba(255,107,53,0.1)',scale:'BWAS',scaleRef:'Andreassen et al., 2012 · Bergen Work Addiction Scale',items:7,maxScore:35,
    questions:[
    ...
    options:["Never","Rarely","Sometimes","Often","Always"],optionValues:[1,2,3,4,5],
    levels:[
...
const IMPACT_MODULES = [
  {id:'sleep',name:'Sleep Disruption',icon:'😴',color:'#7c5cbf',questions:["I use my phone or device immediately before sleeping.","My bedtime is delayed because of digital activities.","I wake up during the night to check my phone or notifications.","I feel tired during the day because of late-night device use.","Notifications or digital activity disturb my sleep quality."]},
  {id:'attention',name:'Attention & Focus',icon:'🧠',color:'#3d6fff',questions:["I find it difficult to concentrate on long tasks without checking my phone.","I frequently switch between apps or digital tasks.","Notifications interrupt my focus and concentration.","I lose concentration easily after checking my phone or social media.","I struggle to read long articles or books without getting distracted."]},
  {id:'productivity',name:'Productivity',icon:'⚡',color:'#f5a623',questions:["Digital distractions interrupt my work or study regularly.","I check my phone while working or studying.","I postpone important tasks because of online activities.","My overall productivity has decreased due to digital distractions.","I struggle to complete tasks without checking my phone or apps."]},
  {id:'emotional',name:'Emotional Health',icon:'❤️',color:'#ff4757',questions:["I feel anxious or unsettled when I cannot access my phone.","I feel stressed by constant notifications and digital demands.","My mood is affected by social media activity or online interactions.","I feel mentally exhausted after prolonged screen use.","Digital activity sometimes makes me feel overwhelmed or hopeless."]}
];
