  ...
  el.innerHTML = `
    <div style="display:flex;align-items:flex-start;gap:12px">
      ...
      <div>
        ...
        <div style="font-size:12px;color:var(--muted);line-height:1.6">I voluntarily agree to share my anonymized assessment data for digital addiction research. No personally identifiable information will be shared.</div>
      </div>
    </div>`;
}
...
<style>
  ...
  <div style="font-size:13px;color:#64748b">Generated: ${date}</div>
  ...
  <div class="footer">
    PAUSE App — Digital Wellness Platform<br>
